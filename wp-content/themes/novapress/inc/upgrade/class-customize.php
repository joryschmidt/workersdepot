 ...
 * @access public
 */
final class Novapress_Customize {
	...
	public function sections( $manager ) {
		...
		$manager->register_section_type( 'Novapress_Customize_Section_Pro' );

		// Register sections.
		$manager->add_section(
			new Novapress_Customize_Section_Pro(
				$manager,
				'upgrade',
				array(
					'title'    => esc_html__( 'Novapress Pro', 'novapress' ),
					'pro_text' => esc_html__( 'View Pro Version',         'novapress' ),
					'pro_url'  => 'https://www.themely.com/themes/novapress-viralnova-clone-wordpress-theme/',
					'priority'    => 1,
				)
			)
		);
...
Novapress_Customize::get_instance();
