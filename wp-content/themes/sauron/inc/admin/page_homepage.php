  ...
  function __construct()
  {
    ...
    $this->options = array(
      ...
      "content_posts_enable" => array(
        ...
        'type' => 'checkbox_open',
        "description" => "",
        'show' => array('content_post_turn_on_animation', 'content_post_categories', 'content_post_count'),
        'hide' => array(),
      ...
      "home_middle_description_post_enable" => array(
        ...
        'type' => 'checkbox_open',
        "description" => '',
        'show' => array("home_middle_description_turn_on_animation", "home_middle_description_post"),
        'hide' => array(),
      ...
      'blog_posts_enable' => array(
        ...
        'type' => 'checkbox_open',
        "description" => "",
        'show' => array("blog_posts_turn_on_animation", 'title' => 'blog_posts_title', 'description' => 'blog_posts_description', 'category' => 'blog_posts_categories'),
        'hide' => array(),
        'section' => 'blog_posts',
        'tab' => 'homepage',
        'default' => true,
      ...
      'gallery_posts_enable' => array(
        ...
        'type' => 'checkbox_open',
        "description" => "",
        'show' => array("gallery_posts_turn_on_animation", 'title' => 'gallery_posts_title', 'description' => 'gallery_posts_description', 'category' => 'gallery_posts_categories'),
        'hide' => array(),
      ...
      'review_posts_enable' => array(
        ...
        'type' => 'checkbox_open',
        "description" => "",
        'show' => array('review_posts_turn_on_animation', 'review_posts_carousel', 'review_posts_time_interval', 'review_posts_stop_hover', 'title' => 'review_posts_title', 'description' => 'review_posts_description', 'category' => 'review_posts_categories'),
        'hide' => array(),
      ...
      'pinned_post_enable' => array(
        ...
        'type' => 'checkbox_open',
        "description" => "",
        'show' => array("pinned_post_turn_on_animation", 'bg_image' => 'pinned_bg_img', 'post' => 'pinned_posts'),
        'hide' => array(),
        'section' => 'pinned_post',
        'tab' => 'homepage',
        'default' => true,
